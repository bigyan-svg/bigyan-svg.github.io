...
>(({ className, ...props }, ref) => (
  <div className="section-glass relative w-full overflow-auto rounded-2xl border border-border/70">
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-white/70 [&_tr]:border-b", className)} {...props} />
));
